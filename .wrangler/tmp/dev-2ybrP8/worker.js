  ...
  "node_modules/fast-sha256/sha256.js"(exports, module) {
    ...
    (function(root, factory2) {
      ...
      function hashBlocks(w, v, p2, pos, len) {
        var a, b2, c2, d2, e, f2, g2, h2, u2, i, j, t1, t2;
        while (len >= 64) {
          a = v[0];
          b2 = v[1];
          c2 = v[2];
          ...
          for (i = 0; i < 64; i++) {
            t1 = (((e >>> 6 | e << 32 - 6) ^ (e >>> 11 | e << 32 - 11) ^ (e >>> 25 | e << 32 - 25)) + (e & f2 ^ ~e & g2) | 0) + (h2 + (K[i] + w[i] | 0) | 0) | 0;
...
// .wrangler/tmp/bundle-jxPwFl/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-jxPwFl/middleware-insertion-facade.js
init_modules_watch_stub();
...
function decodeParameterValueContinuations(header) {
  ...
  paramKeys.forEach((paramVal, key) => {
    header.params[key] = decodeURIComponentWithCharset(
      paramVal.values.sort((a, b2) => a.nr - b2.nr).map((a) => a.value).join(""),
      paramVal.charset
    );
  });
}
...
function base64ArrayBuffer(arrayBuffer) {
  ...
  for (var i = 0; i < mainLength; i = i + 3) {
    ...
    c2 = (chunk & 4032) >> 6;
    d2 = chunk & 63;
    base64 += encodings[a] + encodings[b2] + encodings[c2] + encodings[d2];
  }
  if (byteRemainder == 1) {
    chunk = bytes[mainLength];
    a = (chunk & 252) >> 2;
    b2 = (chunk & 3) << 4;
    base64 += encodings[a] + encodings[b2] + "==";
  } else if (byteRemainder == 2) {
    chunk = bytes[mainLength] << 8 | bytes[mainLength + 1];
    a = (chunk & 64512) >> 10;
    b2 = (chunk & 1008) >> 4;
    c2 = (chunk & 15) << 2;
    base64 += encodings[a] + encodings[b2] + encodings[c2] + "=";
  }
  return base64;
}
...
var Resend = class {
  ...
  async post(path, entity, options = {}) {
    ...
    const isFormData2 = typeof FormData !== "undefined" && entity instanceof FormData;
    if (isFormData2) headers.delete("Content-Type");
    if (options.headers) for (const [key, value] of new Headers(options.headers).entries()) headers.set(key, value);
    if (options.idempotencyKey) headers.set("Idempotency-Key", options.idempotencyKey);
    const requestOptions = {
      method: "POST",
      body: isFormData2 ? entity : JSON.stringify(entity),
      ...options,
      headers
    };
...
// node_modules/@mailerlite/mailerlite-nodejs/dist/index.mjs
init_modules_watch_stub();
...
var toCamelCase2 = /* @__PURE__ */ __name((str) => {
...
function mergeConfig(config1, config2) {
  ...
  const mergeMap = {
    ...
    headers: /* @__PURE__ */ __name((a, b2, prop) => mergeDeepProperties(headersToObject(a), headersToObject(b2), prop, true), "headers")
  };
...
validators.transitional = /* @__PURE__ */ __name(function transitional(validator, version2, message2) {
...
// node_modules/@mailerlite/mailerlite-nodejs/dist/index.mjs
function o(i) {
  if (!i) throw new Error("ID must be provided");
  if (typeof i == "number") throw new Error("ID must be of type string");
}
__name(o, "o");
function s(i = "", e, t) {
  let { headers: r = {}, method: a, body: A = null, params: x = {} } = e, R = C(x);
  return R = R ? `?${R}` : "", axios_default({ method: a, url: t.basePath + i + R, headers: { ...r, Authorization: `Bearer ${t.api_key}`, "X-Requested-With": "XMLHttpRequest", "Content-type": "application/json", "accept-encoding": "null" }, data: A && JSON.stringify(A) });
}
__name(s, "s");
function C(i, e) {
  return Object.keys(i).map((r) => {
    let a = i[r];
    return i.constructor === Array ? r = `${e}[]` : i.constructor === Object && (r = e ? `${e}[${r}]` : r), typeof a == "object" ? C(a, r) : `${r}=${encodeURIComponent(a)}`;
  }).flat(10).join("&");
}
__name(C, "C");
var n = class {
  ...
  get(e) {
    return s("/api/subscribers", { method: "GET", params: e }, this.config);
  }
  createOrUpdate(e) {
    return s("/api/subscribers", { method: "POST", body: e }, this.config);
  }
  update(e, t) {
    return o(e), s(`/api/subscribers/${e}`, { method: "PUT", body: t }, this.config);
  }
  find(e) {
    return o(e), s(`/api/subscribers/${e}`, { method: "GET" }, this.config);
  }
  getCount() {
    return s("/api/subscribers", { method: "GET", params: { limit: 0 } }, this.config);
  }
  delete(e) {
    return o(e), s(`/api/subscribers/${e}`, { method: "DELETE" }, this.config);
  }
  forget(e) {
    return o(e), s(`/api/subscribers/${e}/forget`, { method: "POST" }, this.config);
  }
};
var p = class {
  static {
  ...
  get(e) {
    return s("/api/campaigns", { method: "GET", params: e }, this.config);
  }
  find(e) {
    return o(e), s(`/api/campaigns/${e}`, { method: "GET" }, this.config);
  }
  create(e) {
    return s("/api/campaigns", { method: "POST", body: e }, this.config);
  }
  update(e, t) {
    return o(e), s(`/api/campaigns/${e}`, { method: "PUT", body: t }, this.config);
  }
  schedule(e, t) {
    return o(e), s(`/api/campaigns/${e}/schedule`, { method: "POST", body: t }, this.config);
  }
  cancel(e) {
    return o(e), s(`/api/campaigns/${e}/cancel`, { method: "POST" }, this.config);
  }
  delete(e) {
    return o(e), s(`/api/campaigns/${e}`, { method: "DELETE" }, this.config);
  }
};
var m = class {
  static {
  ...
  get(e, t) {
    return s(`/api/forms/${e}`, { method: "GET", params: t }, this.config);
  }
  update(e, t) {
    return o(e), s(`/api/forms/${e}`, { method: "PUT", body: t }, this.config);
  }
  delete(e) {
    return o(e), s(`/api/forms/${e}`, { method: "DELETE" }, this.config);
  }
};
var c = class {
  static {
  ...
  get(e) {
    return s("/api/groups", { method: "GET", params: e }, this.config);
  }
  create(e) {
    return s("/api/groups", { method: "POST", body: e }, this.config);
  }
  update(e, t) {
    return o(e), s(`/api/groups/${e}`, { method: "PUT", body: t }, this.config);
  }
  delete(e) {
    return o(e), s(`/api/groups/${e}`, { method: "DELETE" }, this.config);
  }
  getSubscribers(e, t) {
    return o(e), s(`/api/groups/${e}/subscribers`, { method: "GET", params: t }, this.config);
  }
  assignSubscriber(e, t) {
    return o(e), o(t), s(`/api/subscribers/${e}/groups/${t}`, { method: "POST" }, this.config);
  }
  unAssignSubscriber(e, t) {
    return o(e), o(t), s(`/api/subscribers/${e}/groups/${t}`, { method: "DELETE" }, this.config);
  }
};
var u = class {
  static {
  ...
  get(e) {
    return s("/api/segments", { method: "GET", params: e }, this.config);
  }
  getSubscribers(e, t) {
    return o(e), s(`/api/segments/${e}/subscribers`, { method: "GET", params: t }, this.config);
  }
  update(e, t) {
    return o(e), s(`/api/segments/${e}`, { method: "PUT", body: t }, this.config);
  }
  delete(e) {
    return o(e), s(`/api/segments/${e}`, { method: "DELETE" }, this.config);
  }
};
var f = class {
  static {
  ...
  get(e) {
    return s("/api/fields", { method: "GET", params: e }, this.config);
  }
  create(e) {
    return s("/api/fields", { method: "POST", body: e }, this.config);
  }
  update(e, t) {
    return o(e), s(`/api/fields/${e}`, { method: "PUT", body: t }, this.config);
  }
  delete(e) {
    return o(e), s(`/api/fields/${e}`, { method: "DELETE" }, this.config);
  }
};
var g = class {
  static {
  ...
  get(e) {
    return s("/api/automations", { method: "GET", params: e }, this.config);
  }
  find(e) {
    return o(e), s(`/api/automations/${e}`, { method: "GET" }, this.config);
  }
  getAutomationSubscribers(e, t) {
    return o(e), s(`/api/automations/${e}/activity`, { method: "GET", params: t }, this.config);
  }
};
var l = class {
  static {
  ...
  get() {
    return s("/api/timezones", { method: "GET" }, this.config);
  }
};
var b = class {
  static {
  ...
  get() {
    return s("/api/campaigns/languages", { method: "GET" }, this.config);
  }
};
var h = class {
  static {
  ...
  send(e) {
    return s("/api/batch", { method: "POST", body: e }, this.config);
  }
};
var d = class {
  static {
  ...
  get() {
    return s("/api/webhooks", { method: "GET" }, this.config);
  }
  find(e) {
    return o(e), s(`/api/webhooks/${e}`, { method: "GET" }, this.config);
  }
  create(e) {
    return s("/api/webhooks", { method: "POST", body: e }, this.config);
  }
  update(e, t) {
    return s(`/api/webhooks/${e}`, { method: "PUT", body: t }, this.config);
  }
  delete(e) {
    return o(e), s(`/api/webhooks/${e}`, { method: "DELETE" }, this.config);
  }
};
var P = class {
  static {
  ...
  getSentCampaigns(e) {
    return e.filter = { status: "sent" }, s("/api/campaigns", { method: "GET", params: e }, this.config);
  }
  async getSentCampaignStats(e) {
    o(e);
    let t = await s(`/api/campaigns/${e}`, { method: "GET" }, this.config);
    if (t.data && t.data.data && t.data.data.stats) return t.data.data.stats;
    throw t.data && t.data.data && t.data.data.status !== "sent" ? new Error("No stats available. See if ID of a sent campaign was provided.") : new Error("No stats available. See if correct ID was provided.");
  }
  async getSentCampaignSubscribers(e, t) {
    return o(e), s(`/api/campaigns/${e}/reports/subscriber-activity`, { method: "POST", body: t }, this.config);
  }
  getFormsByType(e, t) {
    return s(`/api/forms/${e}`, { method: "GET", params: t }, this.config);
  }
  async getFormsCountByType(e) {
    let t = await s(`/api/forms/${e}`, { method: "GET" }, this.config);
    if (t.data && t.data && t.data.meta && t.data.meta.aggregations) return t.data.meta.aggregations[e];
    throw new Error("No stats available.");
  }
  getFormSubscribers(e, t) {
    return s(`/api/forms/${e}/subscribers`, { method: "GET", params: t }, this.config);
  }
  getAutomations(e) {
    return s("/api/automations", { method: "GET", params: e }, this.config);
  }
  async getAutomationStats(e) {
    o(e);
    let t = await s(`/api/automations/${e}`, { method: "GET" }, this.config);
    if (t.data && t.data.data && t.data.data.stats) return t.data.data.stats;
    throw new Error("No stats available.");
  }
  getAutomationSubscribers(e, t) {
...
// src/worker.ts
var getJwtSecret = /* @__PURE__ */ __name((env) => new TextEncoder().encode(env.JWT_SECRET || "default_super_secret_key"), "getJwtSecret");
var worker_default = {
...
async function handleLogin(request, env) {
  ...
  const token = await new SignJWT({ role: "admin" }).setProtectedHeader({ alg: "HS256" }).setExpirationTime("24h").sign(getJwtSecret(env));
  return new Response(JSON.stringify({ success: true }), {
    status: 200,
    headers: {
      "Content-Type": "application/json",
...
async function handleGetNews(request, env) {
  try {
...
async function handleGetNewsBySlugOrId(request, env, identifier) {
  try {
...
__name(handleGetNewsBySlugOrId, "handleGetNewsBySlugOrId");
async function handleCreateNews(request, env) {
  try {
    ...
    const read_more_text = formData.get("read_more_text") || "Read more \u2192";
    const body_content = formData.get("body_content");
    const external_link = formData.get("external_link");
    const mentorship_data = formData.get("mentorship_data");
    const image = formData.get("image");
    let image_url = null;
    let image_alt = formData.get("image_alt");
    if (image && image.name) {
...
__name(handleCreateNews, "handleCreateNews");
async function handleUpdateNews(request, env, id) {
  try {
    const formData = await request.formData();
    const type = formData.get("type");
    const title = formData.get("title");
    ...
    if (image && image.name) {
      ...
      const old_image_url = formData.get("existing_image_url");
...
__name(handleUpdateNews, "handleUpdateNews");
async function handleDeleteNews(request, env, id) {
  try {
    const record = await env.DB.prepare("SELECT image_url FROM news WHERE id = ?").bind(id).first();
    if (record && record.image_url && typeof record.image_url === "string" && record.image_url.startsWith("/assets/uploads/")) {
...
__name(handleDeleteNews, "handleDeleteNews");
async function handleContact(request, env) {
  try {
    const { name, email, message: message2 } = await request.json();
...
async function handleNewsletter(request, env) {
  try {
    ...
    const mailerlite = new S({ api_key: apiKey });
    await mailerlite.subscribers.createOrUpdate({
      email: normalizedEmail,
      fields: name ? { name } : void 0
    });
    return Response.json({
      success: true,
